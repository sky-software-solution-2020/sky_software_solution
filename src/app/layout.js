...
export const metadata = {
 ...
 description: "Sky Software Solution provides IT training at Neemuch, specializing in Web Development Training and the best coding classes at Neemuch!",
  ...
  openGraph: {
    title:"Sky Software Solution",
    description:"Sky Software Solution provides IT training at Neemuch, specializing in Web Development Training and the best coding classes at Neemuch!",
    images:["https://res.cloudinary.com/dhelke9k1/image/upload/v1745390515/Screenshot_2022-06-20_100555_1_unxj7n.png"]
  },
};
...
export default function RootLayout({ children }) {
  ...
  return (
    <html lang="en">
      <head>
        <link rel="icon" href="https://res.cloudinary.com/dhelke9k1/image/upload/v1745390515/Screenshot_2022-06-20_100555_1_unxj7n.png" />
      </head>
